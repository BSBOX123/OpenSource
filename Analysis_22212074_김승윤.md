...
<code>2. Use case analysis .................................................... 4</code><br/>
  <br/>
<code>3. Domain analysis ..................................................... 14</code><br/>
  <br/>
<code>4. User Interface Prototype ............................................ 15</code><br/>
  <br/>
<code>5. Glossary ............................................................ 16</code><br/>
  <br/>
<code>6. References .......................................................... 16</code>
</h3>
...
* 마감일과 난이도를 종합하여 퀘스트의 우선순위를 정확하게 계산하고 정렬할 수 있어야 한다.
* 사용자가 앱을 종료한 상태에서도 시간이 흐름에 따라 마감일 초과 페널티와 일일 퀘스트 갱신이 정상적으로 연산되어야 한다. 
* 애플리케이션의 데이터(퀘스트 목록, 플레이어 스탯)가 기기 내부에 안전하게 저장되고 불러와져야 한다. 
...
제안된 시스템은 개인 사용자를 대상으로 하며 백그라운드 연산을 수행하므로 Actor는 User와 Background Service 두 가지로 나뉜다.
...
**Use case #2: Modify / Delete quest (퀘스트 수정 및 삭제)**
<table frame="box" rules="all">
  <tr>
    <td colspan="2"><b>GENERAL CHARACTERISTICS</b></td>
  </tr>
  <tr>
    <td width="200">Summary</td>
    <td width="600">등록된 퀘스트의 세부 내용(마감일, 난이도 등)을 수정하거나 완전히 삭제한다.</td>
  </tr>
  <tr>
    <td>Scope</td>
    <td>Survive The Semester App</td>
  ...
  <tr>
    <td>Preconditions</td>
    <td>등록된 퀘스트가 최소 1개 이상 존재해야 한다.</td>
  </tr>
  <tr>
    <td>Trigger</td>
    <td>사용자가 리스트 내 특정 퀘스트를 길게 누르거나(Long Click) '수정/삭제' 아이콘을 터치할 때</td>
  </tr>
  <tr>
    <td>Success Post Condition</td>
    <td>DB의 데이터가 성공적으로 갱신(Update) 혹은 삭제(Delete)되고 목록이 재정렬된다.</td>
  </tr>
  <tr>
    <td colspan="2"><b>MAIN SUCCESS SCENARIO</b></td>
  </tr>
  ...
  <tr>
    <td align="center">1</td>
    <td>사용자가 수정/삭제할 퀘스트 항목을 선택한다.</td>
  </tr>
  <tr>
    <td align="center">2</td>
    <td>시스템이 '수정'과 '삭제'를 선택할 수 있는 팝업 메뉴를 띄운다.</td>
  </tr>
  <tr>
    <td align="center">3</td>
    <td>(수정의 경우) 사용자가 내용을 변경하고 저장 버튼을 누르면 DB를 Update 한다.<br/>(삭제의 경우) 사용자가 삭제를 확인하면 DB에서 해당 레코드를 Delete 한다.</td>
  </tr>
  <tr>
    <td align="center">4</td>
    <td>시스템이 리스트를 새로고침하여 사용자에게 보여준다.</td>
  </tr>
  <tr>
    <td colspan="2"><b>EXTENSION SCENARIOS</b></td>
  </tr>
  ...
  <tr>
    <td align="center">3</td>
    <td>
      3a. 수정을 시도할 때 필수 정보(퀘스트명 등)를 지운 상태로 저장을 누른 경우<br/>
      &nbsp;&nbsp;3a.1. 시스템은 빈칸을 채워달라는 경고 메시지를 띄운다.<br/>
      &nbsp;&nbsp;3a.2. 저장을 취소하고 입력 상태를 유지한다.
    </td>
  </tr>
  <tr>
    <td colspan="2"><b>RELATED INFORMATION</b></td>
...
**Use case #3: Complete quest (퀘스트 완료 처리)**
<table frame="box" rules="all">
  <tr>
    <td colspan="2"><b>GENERAL CHARACTERISTICS</b></td>
  </tr>
...
**Use case #4: View quest list (정렬된 퀘스트 목록 조회)**
<table frame="box" rules="all">
  <tr>
    <td colspan="2"><b>GENERAL CHARACTERISTICS</b></td>
  </tr>
  <tr>
    <td width="200">Summary</td>
    <td width="600">우선순위 알고리즘에 의해 중요도 순으로 정렬된 퀘스트 목록을 확인한다.</td>
  </tr>
  <tr>
    <td>Scope</td>
    <td>Survive The Semester App</td>
  ...
  <tr>
    <td>Preconditions</td>
    <td>앱이 실행되어 메인 화면에 진입한 상태여야 한다.</td>
  </tr>
  <tr>
    <td>Trigger</td>
    <td>앱 최초 실행 시, 혹은 퀘스트의 데이터(추가, 완료, 수정)에 변화가 생겼을 때</td>
  </tr>
  <tr>
    <td>Success Post Condition</td>
    <td>가장 급하고 중요한 퀘스트가 리스트 최상단에 올바르게 노출된다.</td>
  </tr>
  <tr>
    <td colspan="2"><b>MAIN SUCCESS SCENARIO</b></td>
  </tr>
  ...
  <tr>
    <td align="center">1</td>
    <td>시스템(EventController)이 DataController에게 진행 중인 퀘스트 목록을 요청한다.</td>
  </tr>
  <tr>
    <td align="center">2</td>
    <td>QueueManager가 마감일과 난이도를 기준으로 퀘스트 목록을 정렬(Priority Queue)한다.</td>
  </tr>
  <tr>
    <td align="center">3</td>
    <td>시스템이 정렬된 배열 데이터를 View에 전달하여 리스트 형태로 렌더링한다.</td>
  </tr>
  <tr>
    <td colspan="2"><b>EXTENSION SCENARIOS</b></td>
  </tr>
  ...
  <tr>
    <td align="center">1</td>
    <td>
      1a. DB에 등록된 진행 중인 퀘스트가 하나도 없는 경우<br/>
      &nbsp;&nbsp;1a.1. 시스템은 정렬 과정을 생략한다.<br/>
      &nbsp;&nbsp;1a.2. 화면 중앙에 "현재 진행 중인 퀘스트가 없습니다. 추가해주세요!" 라는 안내 문구를 출력한다.
    </td>
  </tr>
  <tr>
    <td colspan="2"><b>RELATED INFORMATION</b></td>
...
**Use case #5: View avatar status (아바타 및 스탯 조회)**
<table frame="box" rules="all">
  <tr>
    <td colspan="2"><b>GENERAL CHARACTERISTICS</b></td>
  </tr>
  <tr>
    <td width="200">Summary</td>
    <td width="600">자신의 현재 체력(HP), 경험치(EXP), 보유 재화(Gold) 및 아바타 상태를 확인한다.</td>
  </tr>
  <tr>
    <td>Scope</td>
    <td>Survive The Semester App</td>
  ...
  <tr>
    <td>Preconditions</td>
    <td>기기에 플레이어의 로컬 데이터(Player DB)가 정상적으로 존재해야 한다.</td>
  </tr>
  <tr>
    <td>Trigger</td>
    <td>앱이 실행되거나 플레이어의 스탯 정보가 변동되었을 때</td>
  </tr>
  <tr>
    <td>Success Post Condition</td>
    <td>상단 UI에 레벨별 아바타 이미지와 정확한 스탯 수치가 시각화되어 표출된다.</td>
  </tr>
  <tr>
    <td colspan="2"><b>MAIN SUCCESS SCENARIO</b></td>
  </tr>
  ...
  <tr>
    <td align="center">1</td>
    <td>시스템이 DataController에서 플레이어의 현재 HP, EXP, Gold, Level 데이터를 불러온다.</td>
  </tr>
  <tr>
    <td align="center">2</td>
    <td>현재 레벨 수치에 매핑된 아바타 2D 이미지 리소스를 불러온다.</td>
  </tr>
  <tr>
    <td align="center">3</td>
    <td>최대치(Max HP, Max EXP) 대비 현재 수치를 백분율로 계산하여 게이지 바로 화면에 출력한다.</td>
  </tr>
  <tr>
    <td colspan="2"><b>EXTENSION SCENARIOS</b></td>
  </tr>
  ...
  <tr>
    <td align="center">1</td>
    <td>
      1a. 최초 앱 설치 후 첫 실행이어서 로컬 데이터가 없는 경우<br/>
      &nbsp;&nbsp;1a.1. 시스템은 플레이어 데이터를 초기 기본값(Level 1, HP 100, EXP 0, Gold 0)으로 DB에 자동 생성한다.<br/>
      &nbsp;&nbsp;1a.2. 기본 아바타 이미지를 불러와 출력한다.
    </td>
  </tr>
  <tr>
    <td colspan="2"><b>RELATED INFORMATION</b></td>
...
<table frame="box" rules="all">
  ...
  <tr>
    <td width="200">Summary</td>
    <td width="600">모은 Gold를 소모하여 맞춤형 현실 보상(셀프 보상 쿠폰)을 발급받는다.</td>
  </tr>
  <tr>
    <td>Scope</td>
    <td>Survive The Semester App</td>
  ...
  <tr>
    <td>Preconditions</td>
    <td>상점 메뉴에 진입하여 보상 리스트를 확인한 상태여야 한다.</td>
  </tr>
  <tr>
    <td>Trigger</td>
    <td>상점 화면에서 특정 아이템의 '구매' 버튼을 터치할 때</td>
  </tr>
  <tr>
    <td>Success Post Condition</td>
    <td>Gold가 차감되고, 구매 성공 애니메이션 및 로그가 기록된다.</td>
  </tr>
  <tr>
    <td colspan="2"><b>MAIN SUCCESS SCENARIO</b></td>
  </tr>
  ...
  <tr>
    <td align="center">1</td>
    <td>사용자가 상점에서 아이템 구매를 시도한다.</td>
  </tr>
  <tr>
    <td align="center">2</td>
    <td>시스템은 사용자의 현재 Gold가 아이템 가격보다 크거나 같은지 검증한다.</td>
  </tr>
  <tr>
    <td align="center">3</td>
    <td>(조건 충족 시) 시스템이 DB에서 Gold를 차감하고 구매 내역을 기록한다.</td>
  </tr>
  <tr>
    <td align="center">4</td>
    <td>가상의 쿠폰이 발급되었다는 팝업 애니메이션을 띄운다.</td>
  </tr>
  <tr>
    <td colspan="2"><b>EXTENSION SCENARIOS</b></td>
  </tr>
  ...
  <tr>
    <td align="center">2</td>
    <td>
      2a. 플레이어의 보유 Gold가 요구 가격보다 부족한 경우<br/>
      &nbsp;&nbsp;2a.1. 시스템은 구매를 즉시 거절한다.<br/>
      &nbsp;&nbsp;2a.2. "Gold가 부족합니다. 퀘스트를 더 수행하세요!" 라는 경고 메시지를 띄운다.
    </td>
  </tr>
  <tr>
    <td colspan="2"><b>RELATED INFORMATION</b></td>
...
**Use case #7: Generate daily quest (일일 퀘스트 자정 갱신)**
<table frame="box" rules="all">
  <tr>
    <td colspan="2"><b>GENERAL CHARACTERISTICS</b></td>
  </tr>
  <tr>
    <td width="200">Summary</td>
    <td width="600">자정(00:00)이 되면 가벼운 일일 퀘스트(Daily Quest)를 자동 생성하여 추가한다.</td>
  </tr>
  <tr>
    <td>Scope</td>
    <td>Survive The Semester App</td>
  ...
  <tr>
    <td>Preconditions</td>
    <td>기기의 시간이 정상적으로 흐르고 있어야 한다.</td>
  </tr>
  <tr>
    <td>Trigger</td>
    <td>기기 시간이 00시 00분을 지날 때 (또는 자정 이후 최초 앱 실행 시)</td>
  </tr>
  <tr>
    <td>Success Post Condition</td>
    <td>일일 퀘스트 항목이 DB에 새롭게 Insert 되어 다음 날 목록에 노출된다.</td>
  </tr>
  <tr>
    <td colspan="2"><b>MAIN SUCCESS SCENARIO</b></td>
  </tr>
  ...
  <tr>
    <td align="center">1</td>
    <td>BackgroundScheduler가 날짜가 변경되었음을 감지한다.</td>
  </tr>
  <tr>
    <td align="center">2</td>
    <td>시스템에 미리 지정된 일일 퀘스트(예: 영단어 10개 외우기) 객체를 생성한다.</td>
  </tr>
  <tr>
    <td align="center">3</td>
    <td>DataController를 통해 생성된 퀘스트를 DB에 추가(Insert)한다.</td>
  </tr>
  <tr>
    <td colspan="2"><b>EXTENSION SCENARIOS</b></td>
  </tr>
  ...
  <tr>
    <td align="center">1</td>
    <td>
      1a. 이미 해당 날짜의 일일 퀘스트가 생성되어 존재하는 경우<br/>
      &nbsp;&nbsp;1a.1. 시스템은 중복 생성을 방지하기 위해 생성 로직을 건너뛴다.
    </td>
  </tr>
  <tr>
    <td colspan="2"><b>RELATED INFORMATION</b></td>
...
**Use case #8: Apply penalty (마감일 초과 페널티 적용)**
<table frame="box" rules="all">
  <tr>
    <td colspan="2"><b>GENERAL CHARACTERISTICS</b></td>
  </tr>
...
**Use case #9: Alert penalty (마감일 임박 경고 알림)**
<table frame="box" rules="all">
  <tr>
    <td colspan="2"><b>GENERAL CHARACTERISTICS</b></td>
  </tr>
  <tr>
    <td width="200">Summary</td>
    <td width="600">마감일이 임박한 퀘스트가 있을 경우 시스템이 푸시 알림(Push Notification)을 발송한다.</td>
  </tr>
  <tr>
    <td>Scope</td>
    <td>Survive The Semester App</td>
  ...
  <tr>
    <td>Trigger</td>
    <td>특정 퀘스트의 마감 기한이 24시간 이내로 진입했을 때</td>
  </tr>
  <tr>
    <td>Success Post Condition</td>
    <td>스마트폰 상단 알림 바에 경고 메시지가 출력된다.</td>
  </tr>
  <tr>
    <td colspan="2"><b>MAIN SUCCESS SCENARIO</b></td>
  </tr>
  ...
  <tr>
    <td align="center">1</td>
    <td>백그라운드에서 마감일이 임박한(24시간 내) 미완료 퀘스트를 탐지한다.</td>
  </tr>
  <tr>
    <td align="center">2</td>
    <td>안드로이드의 NotificationManager를 호출하여 알림 채널을 생성한다.</td>
  </tr>
  <tr>
    <td align="center">3</td>
    <td>"[경고] 'ㅇㅇ과제' 마감일이 하루 남았습니다! HP가 차감될 수 있습니다."라는 메시지를 푸시한다.</td>
  </tr>
  <tr>
    <td colspan="2"><b>EXTENSION SCENARIOS</b></td>
  </tr>
  ...
  <tr>
    <td align="center">2</td>
    <td>
      2a. 스마트폰 환경설정에서 사용자가 해당 앱의 푸시 알림 권한을 차단해 둔 경우<br/>
      &nbsp;&nbsp;2a.1. 시스템은 알림 발송을 생략하고 내부 로그만 남긴다.<br/>
      &nbsp;&nbsp;2a.2. 앱 실행 시 상단에 "마감일 알림을 받으려면 권한을 허용해주세요"라는 배너를 띄운다.
    </td>
  </tr>
  <tr>
    <td colspan="2"><b>RELATED INFORMATION</b></td>
...
<div align="center">
  <img src="./images/main.png" alt="Main Home" width="250"/>
  <br/>
  [그림 4-1] Main Home
</div>
<br/>
...
<div align="center">
  <img src="./images/register.png" alt="Add Quest Dialog" width="250"/>
  <br/>
...
<div align="center">
  <img src="./images/store.png" alt="Shop Layout" width="250"/>
  <br/>
  [그림 4-3] Shop Layout
</div>
<br/>
